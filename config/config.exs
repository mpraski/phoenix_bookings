...
config :bookings_web, BookingsWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "/TdNYlTO0pGdjOomeacutz9zJMH5llVt8w64tnot6ZPYKqNtNZkCp4bxEIGvJBHF",
  render_errors: [view: BookingsWeb.ErrorView, accepts: ~w(html json)],
  pubsub: [name: BookingsWeb.PubSub, adapter: Phoenix.PubSub.PG2]
